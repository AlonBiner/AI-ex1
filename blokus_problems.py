...
class BlokusCornersProblem(SearchProblem):
    ...
    def is_goal_state(self, state):
        ...
        return not (state.state[self.board.board_h - 1][self.board.board_w - 1] == -1 or
                    state.state[self.board.board_h - 1][0] == -1
                    or state.state[0][self.board.board_w - 1] == -1)
...
def get_manhattan_dist(target, locations):
    legal_moves_dist = []
    for location in locations:
        legal_moves_dist.append(manhattanDistance(target, location) + 1)
